...
def main():
    ...
    if choice == "1":
        ...
        print("3. 在终端运行以下命令启动Chrome（开启远程调试）：")
        print()
        ...
        print()
        print("4. 在打开的Chrome中访问企查查并登录")
        print("5. 登录成功后，回到这里按回车继续...")
        input()
        ...
        crawler = ChangshaCrawler(use_existing_browser=True, cdp_url=cdp_url)
